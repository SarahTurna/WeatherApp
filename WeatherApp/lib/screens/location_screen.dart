...
class LocationScreenState extends State<LocationScreen> {
  ...
  void updateUI(dynamic weatherData) {
    setState(() {
      ...
      humidity = humid;
      num wind_speed = weatherData['wind']['speed'];
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        var weatherData = await getCityWeatherByLocation(location.latitude,location.longitude);
                        setState(() {
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (enteredCity != null) {
                          ...
                          // Update weather data using the new city
